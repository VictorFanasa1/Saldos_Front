...
private _showCobranzayCredito = new BehaviorSubject<boolean>(false);
  ...
  showcobranzaycredito = this._showCobranzayCredito.asObservable();
  ...
  showConranzayCreditoSet(val:boolean){this._showCobranzayCredito.next(val)}
}
