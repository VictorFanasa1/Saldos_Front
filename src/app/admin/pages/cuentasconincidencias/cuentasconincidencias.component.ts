...
@Component({
  ...
  templateUrl: './cuentasconincidencias.component.html',
  styleUrls: ['./cuentasconincidencias.component.css'],
})
export class CuentasconincidenciasComponent implements OnInit {
